...
<template>
  <AnimatedCard class="training-details-card" :hoverable="false">
    ...
    <div v-if="currentJob" class="details-content">
      <!-- 基本状态 -->
      <div class="detail-section">
        ...
        <div class="detail-item">
          ...
          <div class="item-content">
            ...
            <StatusBadge :status="currentJob.status" size="small" />
          </div>
        </div>
        <div class="detail-item">
          ...
          <div class="item-content">
            ...
            <span class="item-value">{{ currentJob.progress.toFixed(1) }}%</span>
          </div>
        </div>
      </div>
      
      <!-- YOLO 配置 -->
      <div v-if="currentJob.yoloMetrics" class="detail-section">
        <div class="section-title">模型配置</div>
        <div class="detail-item">
          <div class="item-icon model"><Icon icon="ph:cube" :width="12" /></div>
          <div class="item-content">
            <span class="item-label">模型架构</span>
            <span class="item-value highlight">YOLOv8n</span>
          </div>
        </div>
        <div class="detail-item">
          ...
          <div class="item-content">
            ...
            <span class="item-value">{{ currentJob.yoloMetrics.batchSize }}</span>
          </div>
        </div>
        <div class="detail-item">
          ...
          <div class="item-content">
            ...
            <span class="item-value code">{{ currentJob.yoloMetrics.learningRate.toExponential(2) }}</span>
          </div>
        </div>
        <div class="detail-item">
          ...
          <div class="item-content">
            ...
            <span class="item-value">640×640</span>
          </div>
        </div>
      </div>
      ...
      <div v-if="currentJob.yoloMetrics" class="detail-section">
        ...
        <div class="detail-item">
          ...
          <div class="item-content">
            ...
            <span class="item-value">{{ currentJob.yoloMetrics.gpuMemory }}</span>
          </div>
        </div>
        <div class="detail-item">
          ...
          <div class="item-content">
            ...
            <span class="item-value">{{ currentJob.yoloMetrics.gpuUtilization.toFixed(0) }}%</span>
          </div>
        </div>
      </div>
      ...
      <div class="detail-section">
        ...
        <div class="detail-item">
          ...
          <div class="item-content">
            ...
            <span class="item-value">{{ formatTime(currentJob.startedAt) }}</span>
          </div>
        </div>
        <div v-if="currentJob.yoloMetrics" class="detail-item">
          <div class="item-icon"><Icon icon="ph:timer" :width="12" /></div>
          <div class="item-content">
            <span class="item-label">每轮耗时</span>
            <span class="item-value">{{ currentJob.yoloMetrics.epochTime.toFixed(0) }}s</span>
          </div>
        </div>
        <div v-if="currentJob.yoloMetrics" class="detail-item">
          ...
          <div class="item-content">
            ...
            <span class="item-value highlight">{{ currentJob.yoloMetrics.eta }}</span>
          </div>
        </div>
      </div>
      
      <!-- 数据集信息 -->
      <div v-if="currentJob.metrics" class="detail-section">
        ...
        <div class="detail-item">
          ...
          <div class="item-content">
            ...
            <span class="item-value">{{ currentJob.metrics.totalSamples?.toLocaleString() }}</span>
          </div>
        </div>
        <div class="detail-item">
          ...
          <div class="item-content">
            ...
            <span class="item-value">{{ currentJob.metrics.samplesProcessed?.toLocaleString() }}</span>
          </div>
        </div>
        <div class="detail-item full-width">
          <div class="data-progress">
            <div 
              class="progress-fill" 
              :style="{ width: `${((currentJob.metrics.samplesProcessed || 0) / (currentJob.metrics.totalSamples || 1)) * 100}%` }"
            ></div>
          </div>
        </div>
      </div>
